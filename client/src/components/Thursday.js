...
const Thursday = ({thursday, sideList}) => {
    ...
    const remainingProtein = subtractProtein(thursday);
    const remainingCarbs = subtractCarbs(thursday);
    const remainingFat = subtractFat(thursday);
    ...
    const recipesType = thursday.map(recipe => recipe.type);
    if(recipesType.includes('Meat')){
        Array.prototype.push.apply(thursday, side);
    }else if(recipesType.includes('Fish')){
        Array.prototype.push.apply(thursday, side);
    }

    const breakfast = thursday.slice(0, 1);
    const dinner = findDinnerRecipes(thursday);
            ...
            <td className="macrooftheday">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td className="total-gram">{subtractProtein(thursday)}</td>
                            <td className="total-gram">{subtractCarbs(thursday)}</td>
                            <td className="total-gram">{subtractFat(thursday)}</td>
                        </tr>
                    </tbody>
                </table>
            </td>
            ...
            <td className="calo">
                <table className="caloriesoftheday">
                    <tbody>
                        ...
                        <tr>
                            <td className="total-gram">{addCalories(thursday)}</td>
                        </tr>
                    </tbody>
                </table>
            </td>
